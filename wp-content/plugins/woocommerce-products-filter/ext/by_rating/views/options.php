...
<li data-key="<?php echo $key ?>" class="woof_options_li">
    ...
    <a href="#" data-key="<?php echo $key ?>" data-name="<?php esc_html_e("Search by rating", 'woocommerce-products-filter'); ?>" class="woof-button js_woof_options js_woof_options_<?php echo $key ?> help_tip" data-tip="<?php esc_html_e('additional options', 'woocommerce-products-filter') ?>"><span class="icon-cog-outline"></span></a>
