...
abstract class WOOF_META_FILTER_TYPE {
    ...
    public function draw_meta_filter_structure() {
        ...
        ?>
            ...
            <strong class="woof_fix1"><?php echo $this->woof_settings['meta_filter'][$this->meta_key]['title'] ?>:</strong>
            ...
            <a href="#" data-key="<?php echo $this->meta_key ?>" data-name="<?php echo $this->woof_settings['meta_filter'][$this->meta_key]['title'] ?>" class="woof-button js_woof_options js_woof_options_<?php echo $this->meta_key ?> help_tip" data-tip="<?php esc_html_e('additional options', 'woocommerce-products-filter') ?>"><span class="icon-cog-outline"></span></a>
                <?php
