...
final class WOOF_META_FILTER extends WOOF_EXT {
    ...
    public function woof_print_html_type_options_meta() {//old
        ...
        <li data-key="<?php echo $key ?>" class="woof_options_li">
            ...
            <strong class="woof_fix1"><?php echo $this->woof_settings['meta_filter'][$key]['title'] ?>:</strong>
            ...
            <a href="#" data-key="<?php echo $key ?>" data-name="<?php echo $this->woof_settings['meta_filter'][$key]['title'] ?>" class="woof-button js_woof_options js_woof_options_<?php echo $key ?> help_tip" data-tip="<?php esc_html_e('additional options', 'woocommerce-products-filter') ?>"><span class="icon-cog-outline"></span></a>
            <?php
            $data = array();
            $data['key'] = $key;
