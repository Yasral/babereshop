    ...
    <div class="woof_container_inner">
        <div class="woof_container_inner woof_container_inner_meta_mselect">
            ...
            <div class="<?php echo $css_classes ?>">
                <select class="woof_meta_mselect woof_meta_mselect_<?php echo $meta_key ?>" name="<?php echo "mselect_" . $meta_key ?>"multiple="multiple" data-placeholder="<?php echo WOOF_HELPER::wpml_translate(null, $options['title']) ?>" data-options_separator="<?php echo $options_separator; ?>">
