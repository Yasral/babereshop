        ...
        <div class="notice notice-info" id="pn_<?php echo $slug ?>_ask_favour" style="position: relative;">
            ...
            <div id="pn_<?php echo $slug ?>_review_yes" style="display: none;">
                ...
                <p>
                    ...
                    <a href="<?php echo $link ?>" onclick="pn_<?php echo $slug ?>_dismiss_review(2)" target="_blank" style="display: inline-block; margin-right: 10px; color: #2eca8b;"><?php esc_html_e('Okay, you deserve it', 'woocommerce-products-filter'); ?></a>
