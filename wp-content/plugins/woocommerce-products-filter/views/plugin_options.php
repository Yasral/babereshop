                                                ...
                                                <li class="woof_ext_li <?php echo($checked ? 'is_enabled' : 'is_disabled'); ?>">
                                                    ...
                                                    <div class="woof_ext-cell">
                                                        <label for="<?php echo esc_attr($idx) ?>">
                                                            <input type="checkbox" id="<?php echo esc_attr($idx) ?>" <?php if (isset($info['status']) AND $info['status'] == 'premium' AND $this->is_free_ver): ?>disabled="disabled"<?php endif; ?> <?php if ($checked): ?>checked=""<?php endif; ?> value="<?php echo $idx ?>" name="woof_settings[activated_extensions][]" />
                                                            <?php
                                                    ...
                                                    <div class="woof_ext-cell">
                                                        <a href="javascript:void(0)" class="woof_ext_remove" data-idx="<?php echo $idx ?>" title="<?php _e('remove extension', 'woocommerce-products-filter') ?>">
                    ...
                    <div class="woof-p-4">
                        ...
                        <?php if (time() < 1638403199): ?>
                            <div style="text-align: center;">
                                ...
                                <img src="https://gen.sendtric.com/countdown/ux29x2tm1x" alt="Cyber Monday 2021 timer"><br>
                            </div>
                        <?php endif; ?>
...
function woof_print_tax($key, $tax, $woof_settings) {
    ...
    <li data-key="<?php echo $key ?>" class="woof_options_li">
        ...
        <input type="text" class="woof_excluded_terms" name="woof_settings[excluded_terms][<?php echo $key ?>]" placeholder="<?php esc_html_e('excluded terms ids', 'woocommerce-products-filter') ?>" value="<?php echo $excluded_terms ?>" />
        <?php $rev_id = uniqid('re-') ?>
        <input <?php echo(((isset($WOOF->settings['excluded_terms_reverse']) ? is_array($WOOF->settings['excluded_terms_reverse']) : FALSE) ? in_array($key, (array) array_keys($WOOF->settings['excluded_terms_reverse'])) : false) ? 'checked="checked"' : '') ?> type="checkbox" name="woof_settings[excluded_terms_reverse][<?php echo $key ?>]" id="<?php echo $rev_id ?>" value="1" />
        <label class="woof_fix17" for="<?php echo $rev_id ?>"><?php esc_html_e('Reverse', 'woocommerce-products-filter') ?></label>
        ...
        <a href="#" data-taxonomy="<?php echo $key ?>" data-taxonomy-name="<?php echo $tax->labels->name ?>" class="woof-button js_woof_add_options help_tip" data-tip="<?php esc_html_e('additional options', 'woocommerce-products-filter') ?>"><span class="icon-cog-outline"></span></a>
    ...
    switch ($key) {
        case 'by_price':
            ...
            <li data-key="<?php echo $key ?>" class="woof_options_li">
                ...
                <a href="#" data-key="<?php echo $key ?>" data-name="<?php esc_html_e("Search by Price", 'woocommerce-products-filter'); ?>" class="woof-button js_woof_options js_woof_options_<?php echo $key ?> help_tip" data-tip="<?php esc_html_e('additional options', 'woocommerce-products-filter') ?>"><span class="icon-cog-outline"></span></a>
